...
type GatewayConfig struct {
	...
	// CodexGeminiImageModel is the hosted image-tool default for OpenAI-group
	// keys that inherit it. The image group supplies upstreams and permissions.
	CodexGeminiImageModel string `mapstructure:"codex_gemini_image_model"`
...
func setDefaults() {
	...
	viper.SetDefault("webauthn.rp_display_name", "TToken")
	...
	viper.SetDefault("gateway.codex_gemini_image_model", "")
