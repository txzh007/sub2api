...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/:id/copy-to-image-provider", h.Admin.Account.CopyToImageProvider)
...
func registerChannelRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	channels := admin.Group("/channels")
	{
		...
		channels.PUT("/pricing-catalog", h.Admin.Channel.SaveModelPricingOverride)
		channels.DELETE("/pricing-catalog", h.Admin.Channel.DeleteModelPricingOverride)
		channels.POST("/pricing-catalog/refresh", h.Admin.Channel.RefreshModelPricingCatalog)
