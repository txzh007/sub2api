...
const (
	...
	// FieldImageBridgeModel holds the string denoting the image_bridge_model field in the database.
	FieldImageBridgeModel = "image_bridge_model"
...
var (
	...
	// ImageBridgeModelValidator is a validator for the "image_bridge_model" field. It is called by the builders before save.
	ImageBridgeModelValidator func(string) error
...
// ByImageBridgeModel orders the results by the image_bridge_model field.
func ByImageBridgeModel(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldImageBridgeModel, opts...).ToFunc()
}
