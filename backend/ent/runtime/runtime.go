...
func init() {
	...
	// apikeyDescImageBridgeModel is the schema descriptor for image_bridge_model field.
	apikeyDescImageBridgeModel := apikeyFields[4].Descriptor()
	// apikey.ImageBridgeModelValidator is a validator for the "image_bridge_model" field. It is called by the builders before save.
	apikey.ImageBridgeModelValidator = apikeyDescImageBridgeModel.Validators[0].(func(string) error)
	...
	// accountDescPurpose is the schema descriptor for purpose field.
	accountDescPurpose := accountFields[4].Descriptor()
	// account.DefaultPurpose holds the default value on creation for the purpose field.
	account.DefaultPurpose = accountDescPurpose.Default.(string)
	// account.PurposeValidator is a validator for the "purpose" field. It is called by the builders before save.
	account.PurposeValidator = accountDescPurpose.Validators[0].(func(string) error)
	...
	// groupDescSystemRole is the schema descriptor for system_role field.
	groupDescSystemRole := groupFields[9].Descriptor()
	// group.DefaultSystemRole holds the default value on creation for the system_role field.
	group.DefaultSystemRole = groupDescSystemRole.Default.(string)
	// group.SystemRoleValidator is a validator for the "system_role" field. It is called by the builders before save.
	group.SystemRoleValidator = groupDescSystemRole.Validators[0].(func(string) error)
