...
type Account struct {
	...
	// Operational purpose: general or image_provider
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldName, account.FieldNotes, account.FieldPlatform, account.FieldType, account.FieldPurpose, account.FieldStatus, account.FieldErrorMessage, account.FieldTempUnschedulableReason, account.FieldSessionWindowStatus, account.FieldQuotaDimension:
