export default {
    ...
    modelPricing: {
      ...
      addRule: '新增价格规则',
      totalModels: '模型总数',
      effectiveCatalog: '目录价与覆盖规则合并后的结果',
      modelCoverage: '{active} 个当前有效，{deprecated} 个老旧模型',
      localOverrides: '本地覆盖',
      hotReloaded: '写入后热加载，无需重启',
      unpricedModels: '有效模型未定价',
      needsAttention: '只统计当前有效模型，需补充价格以避免按 0 元计费',
      allPriced: '当前有效 Token 模型均已有价格',
      overrideFile: '覆盖文件',
