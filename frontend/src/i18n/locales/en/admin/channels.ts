export default {
    ...
    modelPricing: {
      ...
      enabledGroupModels: 'Models in active groups',
      groupCoverage: 'From {groups} active groups; {catalog} catalog entries',
      ...
      inheritedRule: 'Inherits {rule}',
      deprecated: 'Deprecated',
      deprecationDate: 'Deprecation date: {date}',
      usedByGroups: 'Active groups: {groups}',
      unknownProvider: 'Provider not set',
      sourceOverride: 'Local override',
      sourceCatalog: 'Catalog',
      sourceInherited: 'Inherited rule',
      sourceMissing: 'Unpriced',
      ...
      filters: {
        ...
        specificGroup: 'Group: {group}',
        fullCatalog: 'Full pricing catalog',
        unusedCatalog: 'Unused by active groups',
      ...
      groupModelsLoadPartial: 'Model lists failed to load for {count} groups; results may be incomplete',
