export default {
    ...
    modelPricing: {
      ...
      description: 'Maintain catalog prices and local overrides for every model in one place',
      refreshRemote: 'Sync remote catalog',
      addRule: 'Add pricing rule',
      totalModels: 'Effective models',
      effectiveCatalog: 'Catalog and override rules combined',
      modelCoverage: '{active} currently active, {deprecated} deprecated',
      localOverrides: 'Local overrides',
      hotReloaded: 'Applied immediately without a restart',
      unpricedModels: 'Active models unpriced',
      needsAttention: 'Counts active models only; add prices to avoid zero-cost billing',
      allPriced: 'All active token models currently have prices',
      ...
      deprecationDate: 'Deprecation date: {date}',
      unknownProvider: 'Provider not set',
      sourceOverride: 'Local override',
      sourceCatalog: 'Catalog',
      restoreCatalog: 'Remove override and restore catalog price',
      restoreAction: 'Remove override',
      restoreConfirm: 'Remove the local override for “{model}”? The catalog or fallback price will take effect immediately.',
      editRule: 'Edit pricing rule',
      editorHint: 'OpenAI, Gemini, Claude, and Grok use USD. All other models use RMB at the entered numeric value, with no FX conversion.',
      modelOrPrefix: 'Model or prefix rule',
      mode: 'Mode',
      provider: 'Provider',
      ...
      filters: {
        activeOnly: 'Current active models only',
        allLifecycles: 'All models',
        deprecatedOnly: 'Deprecated models only',
      ...
      priceRequired: 'Enter at least one price',
      modelRequired: 'Enter a model name or prefix rule',
      loadFailed: 'Failed to load the model pricing catalog',
      refreshSuccess: 'Remote pricing catalog synchronized',
      refreshFailed: 'Failed to synchronize the remote pricing catalog',
      saveSuccess: 'Pricing rule saved and applied',
      saveFailed: 'Failed to save pricing rule',
      restoreSuccess: 'Override removed and catalog price restored',
      restoreFailed: 'Failed to restore catalog pricing'
    },
