export default {
  ...
  keys: {
    ...
    imageBridgeHint: 'Models come from the 生图 group. Text uses the main group; images use the selected model and the image group’s pricing.',
    imageBridgeEmpty: 'No models available. Enable the 生图 group and configure an available image account.',
