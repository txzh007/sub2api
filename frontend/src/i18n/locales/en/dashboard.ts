export default {
  imageProviders: {
    ...
    description: 'Manage independent image upstream URLs, credentials and models',
    hint: 'Providers belong to the “生图” group for OpenAI key bridging. Clients use the OpenAI Images API.',
    ...
    copyConfirm: 'Copy as image account',
    copying: 'Copying…',
    copySuccess: 'Copied as image account “{name}”. Review it before enabling.',
    accountType: 'Account type',
    accountTypeHint: 'Choose OpenAI, Gemini, or Grok / xAI to match the upstream account. The system selects the image route from the account type.',
    models: 'Image models',
    fetchModels: 'Fetch remote models',
    fetchingModels: 'Fetching…',
    fetchModelsHint: 'Select models from the remote list, then save. Editing fetches automatically using the saved key.',
    fetchToSelect: 'Enter the URL and key, then click “Fetch remote models” to select.',
    ...
    selectModelRequired: 'Select at least one image model.',
    searchModels: 'Search remote models',
    imageModelsOnly: 'Image-related names only',
    selectVisibleModels: 'Select visible models',
    remoteModelsCount: 'Showing {count} / {total} remote models',
    noMatchingModels: 'No matching models. Turn off the name filter or change the search.',
    noRemoteModels: 'The upstream returned no models. Retry or enter models manually.',
    modelsHint: 'One model per line, or alias=upstream-model. The image group model list can restrict available choices.',
    invalidModels: 'Enter explicit model names and mapping targets. Wildcards are not supported.',
    keepKey: 'Leave blank to keep the existing key',
    concurrency: 'Maximum concurrency',
    groupUnavailable: 'Enable a group named “生图” and allow image generation first.',
    enable: 'Enable',
    disable: 'Disable',
    disabled: 'Disabled',
    deleteTitle: 'Delete image provider',
    deleteConfirm: 'Delete image provider “{name}”? Its account and all group associations will also be removed.',
    deleteImpact: 'If no other provider serves a model, keys using that model will be unable to generate images.',
    deleting: 'Deleting…',
    deleted: 'Image provider deleted',
    failed: 'Operation failed. Please retry.',
    saved: 'Image provider saved',
  },
  dashboard: {
    title: 'Dashboard',
  ...
  keys: {
    ...
    groupLabel: 'Group',
    imageBridgeModel: 'Image bridge model',
    imageBridgeDisabled: 'No bridge',
    imageBridgeDefault: 'Use server defaults',
    imageBridgeHint: 'Text uses the main group; images use the selected model from the dedicated image pool and its pricing.',
    imageBridgeEmpty: 'No models available. Enable the image group and configure a schedulable image provider.',
    imageBridgeLoadFailed: 'Unable to load image models',
    imageBridgeRetry: 'Retry',
    imageBridgeUnavailable: 'Unavailable',
    imageBridgeReasonNoProvider: 'No image provider in the group exposes this model',
    imageBridgeReasonAccountInactive: 'The provider exposing this model is inactive',
    imageBridgeReasonAccountUnschedulable: 'The provider exposing this model is paused',
    imageBridgeReasonWrongPurpose: 'The account is not marked as an image provider',
    imageBridgeReasonNotAllowed: 'The model is not in the image group allowlist',
    imageBridgeReasonTemporary: 'The provider is temporarily unavailable',
